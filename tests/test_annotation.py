...
class AnnotationServiceTestCase(unittest.TestCase):
    ...
    def test_document_message_contract(self):
        ...
        # sent downstream.
        self.assertEqual(message["event_name"], "store_annotation")
        ...
        self.assertEqual(message["review"], {"status": "pending", "notes": ""})
    ...
    def test_handle_annotation_event_runs_detector_and_forwards_result(self):
        ...
        self.assertEqual(published_message["event_name"], "store_annotation")
        ...
        self.assertEqual(published_message["objects"], objects)
        self.assertEqual(published_message["review"], {"status": "pending", "notes": ""})
